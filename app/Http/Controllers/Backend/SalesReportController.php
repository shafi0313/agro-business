...
class SalesReportController extends Controller
{
    public function userCash()
    {
        ...
        $users = EmployeeInfo::whereIn('employee_main_cat_id',[11,12,13])->orderby('employee_main_cat_id','ASC')->get();
    ...
    public function showReportCash(Request $request)
    {
        ...
        if($emp_id==11){
            ...
            $reports = SalesReport::join('sales_ledger_books','sales_reports.sales_ledger_book_id', '=', 'sales_ledger_books.id')

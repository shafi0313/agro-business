        ...
        <div class="print_page" id="print_page">
            ...
            <div class="inv_info">
                ...
                <div class="invoice_info">
                    ...
                    @else
                    <div class="return_invoice_text">RETURN INVOICE </div>
                    @endif
                    <table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;:</td>
                            <td>{{ bdDate($ledger->invoice_date) }}</td>
                        </tr>
                        <tr>
                            <td class="text-right" style="color: blue">{{ $ledger->r_type==0?'Payment':'Received' }}  Date</td>
                            <td>&nbsp;:</td>
                            <td style="color: blue">{{ bdDate($ledger->payment_date) }}</td>
                        </tr>
                        <tr>
                            <td class="text-right">Purchase Method</td>
                            <td>&nbsp;:</td>

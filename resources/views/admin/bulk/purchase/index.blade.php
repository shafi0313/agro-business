                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-success btn-sm  ml-auto" href="{{ route('purchaseBulk.selectDate') }}">
                                    All Challan By Date
                                </a>
                                <a class="btn btn-primary btn-sm ml-3" href="{{ route('purchaseBulk.allInvoice') }}">
                                    All Challan
                                </a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('purchaseBulk.create',$supplier->id) }}">Purchase</a>
                                                <span>||</span>
                                                <a href="{{ route('purchase-bulk.show',$supplier->id)}}">Show</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>

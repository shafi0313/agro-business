        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="{{ route('sales-bulk.index')}}">Bulk Sales</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <p style="font-size: 30px; font-weight: bold;margin-top:-10px">Bulk Sales</p>
                                </div>
                                <div class="col-md-3">
                        ...
                        <form action="{{ route('sales-bulk.store') }}" method="post">
                         @csrf
                            ...
                            <div class="row " >
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="challan_no" value="{{$invoice_no}}" class="form-control form-control-sm" readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <label for=""   class="form-label form-label-sm">Invoice No <span class="t_r">*</span></label>
                                        <input type="number" name="invoice_no" value="{{$invoice_no}}" class="form-control form-control-sm" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="inv_type" id="inv_type" required>
                                            <option selected value disabled>Select</option>
                                            <option value="16" >Cash</option>
                                            <option value="18" >Credit</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.qty').on('keyup',function(e) {
            ...
            var net_weight = $('#net_weight').val();
            var price = $('#price').val();
            var result = Number(sum)*Number(price)
            $('#net_weight').val(sum);
            $('#subtotal').val(result);
            total_price();
            $.ajax({

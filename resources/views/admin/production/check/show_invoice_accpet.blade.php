        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item active">Store Chaeck</li>
                </ul>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="{{route('production-check.store')}}" method="post">
                                    @foreach($showInvoices as $showInvoice)
                                        @csrf
                                        <input type="hidden" name="id[]" value="{{ $showInvoice->id }}">
                                        <input type="hidden" name="challan_no[]" value="{{ $showInvoice->challan_no }}">
                                        <input type="hidden" name="use_weight[]" value="{{ $showInvoice->use_weight }}">

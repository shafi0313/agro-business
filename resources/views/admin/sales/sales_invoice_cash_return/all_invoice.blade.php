                                ...
                                <table id="multi-filter-select" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('salesInvoiceCashReturn.printInvoice', [$challan->customer_id, $challan->invoice_no]) }}" target="_blank">Print Invoice</a>
                                                {{-- <span> | </span>
                                                <a href="{{ route('salesInvoiceCashReturn.allInvoiceShow', [$challan->invoice_no]) }}">Show</a> --}}
                                            </td>
                                            {{-- <td class="text-center">

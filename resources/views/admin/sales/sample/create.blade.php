...
<div class="main-panel">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <p style="font-size: 30px; font-weight: bold;margin-top:-10px">Sample Invoice</p>
                                </div>
                                <div class="col-md-3">
                        ...
                        <form action="{{ route('sample-invoive.store') }}" method="post" onsubmit="return validate()">
                         @csrf
    ...
    {{--__________________________________Invoice Info Start__________________________________--}}
                            <div class="row justify-content-between">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group ">
                                        <label for="" class="form-label form-label-sm">Note <span class="t_r">*</span></label>
                                ...
                                {{-- <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="user_id" required>
                                            <option selected value disabled>Select</option>
                                            <option value="10">Rafiquzzaman Tuhin</option>
...
<script>
    ...
    $(document).ready(function(){
        $('.add_porduct').on('click', function() {
            ...
            var html = '<tr>';
            html += '<tr class="trData"><td class="serial text-center"></td><td>' + product_name + '</td><td>' + group_name + '</td><td class="text-center">'+ size_text +'</td><td class="text-center">' + quantity + '</td><td class="text-right">' + parseFloat(rate_per_qty).toFixed(2) + '</td><td class="text-right">' + parseFloat(totalamount).toFixed(2) + '</td><td align="center">';
        ...
        //     if((credit_limit != '') && (total > credit_limit)){

        ...
        border: 0px solid white !important;
            ...
            <table class="table table_bordered table-sm invoice_table">
                ...
                <tr class="net_amt " style="border-top: 1px ">
                    <input id="net_amt" value="{{$getShowInvoices->sum('amt')- ($ledger->sales_amt * $ledger->discount/100)}}" type="hidden">
                    ...
                    <td style="border: none !important" class="text-right net_border"><span class="net_border2">{{ number_format(round($getShowInvoices->sum('amt')- ($ledger->sales_amt * $ledger->discount/100)),2) }}</span> </td>
                </tr>
            </table>

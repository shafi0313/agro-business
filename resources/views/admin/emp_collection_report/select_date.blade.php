...
@section('content')
@php $p='factory'; $sm="balkPurchase" @endphp
        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="{{ route('sales-invoice-cash.index') }}">Employee Collection Report</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body" >
                            ...
                            <form action="{{ route('collectionReport.showReport') }}" method="post">
                                @csrf

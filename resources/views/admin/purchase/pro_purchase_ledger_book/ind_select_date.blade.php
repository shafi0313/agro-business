            ...
            <div class="page-inner">
                <div class="page-header">
                    <ul class="breadcrumbs">
                        ...
                        <li class="separator"><i class="flaticon-right-arrow"></i></li>
                        <li class="nav-item"><a href="{{ route('purchaseLedgerBook.index') }}">Product Purchase Ledger
                                Book</a></li>
                        <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="{{ route('proPurchaseLedgerBook.showInvoice') }}" method="get">
                                    {{-- @csrf --}}
                                    <input type="hidden" name="supplier_id" value="{{ $supplier_id->id }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="date" name="form_date" class="form-control"
                                                        id="form_date" placeholder="Email">
                                                </div>

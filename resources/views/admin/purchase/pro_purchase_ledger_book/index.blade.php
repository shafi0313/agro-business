        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item active">Product Purchase Ledger Book</li>
                </ul>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-primary btn-sm ml-3 ml-auto" href="{{ route('proPurchaseLedgerBook.allShowInvoice') }}">
                                    All Ledger Book
                                </a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('proPurchaseLedgerBook.indAllLedgerBook', $supplier->id)}}">Show All</a>
                                                <span> || </span>
                                                <a href="{{ route('proPurchaseLedgerBook.SelectDate', $supplier->id)}}">Show By Date</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>

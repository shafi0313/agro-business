        ...
        border: 0px solid white !important;
            ...
            <table class="table table_bordered table-sm invoice_table">
                ...
                <tr class="net_amt " style="border-top: 1px ">
                    <input id="net_amt" value="{{$ledger->purchase_amt}}" type="hidden">
                    ...
                    <td style="border: none !important" class="text-right net_border"><span class="net_border2">{{ number_format(round($ledger->purchase_amt),2) }}</span> </td>
                </tr>
            </table>

                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <p style="font-size: 30px; font-weight: bold;margin-top:-10px">Product Purchase</p>
                                </div>
                                <div class="col-md-3">
    ...
    {{--__________________________________Invoice Info Start__________________________________--}}
                        <style>
                            ...
                            <div class="row justify-content-between">
                                ...
                                {{-- @isset($supplier->customerInfo->type)
                                    @if ($supplier->customerInfo->type==1)
                                    @php $type = 'Dealer' @endphp
                                    @elseif ($supplier->customerInfo->type==2)
    ...
    {{--__________________________________Product Show Start__________________________________--}}
                            <table class="table table-responsive table-bordered table-hover table-sm product_table ">
                                <thead class="text-center" style="font-size: 15px;">
                                    ...
                                    @endif
                                    @isset($supplier->customerInfo->credit_limit)
                                    <input type="hidden" id="credit_limit" value="{{ $supplier->customerInfo->credit_limit }}">
                                    @else
...
<script>
    $(document).ready(function(){
        ...
        //             method: 'get',
        //             data: {inv_no: inv_no, supplier_id:supplier_id},
        //             success: function(data){

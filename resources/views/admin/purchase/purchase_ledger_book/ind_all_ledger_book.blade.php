                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body" id="printableArea">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2><strong>Supplier Name: </strong>{{ $supplierInfo->supplier->business_name }}
                                        </h2>
                                        <h2><strong>Proprietor: </strong>{{ $supplierInfo->supplier->name }}</h2>
                                        <p>
                                            <span><strong>Supplier Phone:
                                                </strong>{{ $supplierInfo->supplier->phone }}</span><br>
                                            <span><strong>Supplier Address:
                                                </strong>{{ $supplierInfo->supplier->address }}</span><br>
                                        </p>
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right">
                                                    {{ number_format($openingBl->sum('purchase_amt'), 2) }}</th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                                <th class="text-right">{{ number_format($openingBl->sum('payment'), 2) }}
                                                </th>
                                                @php
                                                    $openingBlCal = $openingBl->sum('purchase_amt') - $openingBl->sum('payment');
                                                @endphp
                                            ...
                                            @endif --}}
                                                    @php
                                                        $invoiceText = match ($invoice->type) {
                                                            7 => 'Bulk',
                                                            9 => 'Bulk Send To Repack Uni',
                                                            11 => 'Bulk Send To Repack Production',
                                                            13 => 'Label',
                                                    ...
                                                    <td>{{ $invoiceText }}</td>
                                                    <td class="text-right">
                                                        {{ number_format(abs($invoice->purchase_amt), 2) }}</td>

                                                    @if (isset($invoice->account_id))
                                                        <td>{{ \Carbon\Carbon::parse($invoice->account->m_r_date)->format('d/m/Y') }}
                                                        </td>
                                                    @else
                                                        <th></th>
                                                    @endif
                                                    ...
                                                    <td class="text-right">
                                                        {{ number_format($openingBlCal + ($balance += $b), 2) }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        <style>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>{{ number_format($openingBlCal + $invoices->sum('purchase_amt'), 2) }}
                                                </td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                ...
                                                <td>{{ number_format($openingBlCal + $invoices->sum('purchase_amt') - $invoices->sum('payment'), 2) }}
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>

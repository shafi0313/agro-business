                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.companyInfo.frontUpdate')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row justify-content-center">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="email" id="email" type="email" class="form-control" value="{{ $data->email }}">
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="address" id="address" type="text" class="form-control" value="{{ $data->address }}" required>

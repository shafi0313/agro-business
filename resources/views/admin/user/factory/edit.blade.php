...
@section('content')
@php $p='business'; $sm="factory"; @endphp
        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="{{ route('company-factory.index')}}">Show Factory</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item active">Edit Factory</li>
                </ul>
            </div>
            <div class="row">
                {{-- <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Edit Factory</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            @endif
                            <form action="{{ route('company-factory.update', $user->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label for="tmm_so_id">Factory Id<span class="t_r">*</span></label>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 5px">
                                        <div class="form-button-action">
                                            ...
                                            <a href="{{route('factory.userFileDestroy', $userFile->id)}}"  class="btn btn-link btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-times"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
  ...
  <div class="modal fade" id="customer" tabindex="-1" role="dialog" aria-labelledby="customerLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"  role="document">
      <div class="modal-content">
        ...
        <form action="{{route('factory.userFileStore')}}" method="POST" enctype="multipart/form-data">
            @csrf

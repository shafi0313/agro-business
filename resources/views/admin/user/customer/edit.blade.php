...
@section('content')
                                ...
                                <form action="{{ route('customer.update', $user->id) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <select name="type" class="form-control" required>
                                                <option value="1" {{ $user->customerInfo->type == 1 ? 'selected' : '' }}>
                                                    Dealer</option>
                                                <option value="2" {{ $user->customerInfo->type == 2 ? 'selected' : '' }}>
                                                    Retailer</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" name="tmm_so_id"
                                                class="form-control @error('tmm_so_id') is-invalid @enderror"
                                                value="{{ $user->tmm_so_id }}">
                                            @error('tmm_so_id')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="number" name="credit_limit"
                                                ...
                                                value="{{ $user->customerInfo->credit_limit }}" required>
                                            @error('credit_limit')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="nominee_name"
                                                ...
                                                value="{{ $user->customerInfo->nominee_name }}">
                                            @error('nominee_name')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" name="nominee_phone"
                                                class="form-control @error('nominee_phone') is-invalid @enderror"
                                                value="{{ $user->customerInfo->nominee_phone }}">
                                            @error('nominee_phone')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="relation"
                                                ...
                                                value="{{ $user->customerInfo->relation }}">
                                            @error('relation')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <textarea name="shop_address" id="" cols="15" rows="6"
                                                class="form-control @error('shop_address') is-invalid @enderror">{{ $user->customerInfo->shop_address }}</textarea>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <textarea name="address" id="" cols="15" rows="6"
                                    ...
                                    <div id="cal" class="row col-md-12">
                                        <div class="form-group col-sm-6">
                                            ...
                                            @else
                                                @php $note = '' @endphp
                                            @endif
                                            <input type="text" name="opening_bl_note"
                                                class="form-control @error('opening_bl_note') is-invalid @enderror"
                                                value="{{ $note }}" placeholder="Enter Note">
                                        ...
                                        <div class="form-group col-sm-2">
                                            ...
                                            <input type="text" name="total" class="form-control num" id="total"
                                                value="{{ $opening_blGet }}">
                                        </div>
                                    </div>
                                    <hr class="bg-warning">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <img src="{{ asset('uploads/images/product/' . $user->profile_photo_path) }}"
                                                height="200" width="200" alt="">
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label for="image" class="placeholder">Image<span
                                ...
                                <table class="table">
                                    ...
                                    <div align="right">
                                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                            data-target="#customer" style="width: 200px"> Add New File</button>
                                    </div>
                                    <tr>
                                        <th>Old File</th>
                                    ...
                                    @foreach ($userFiles as $userFile)
                                        <tr>
                                            ...
                                            @if ($exten == 'jpg' || $exten == 'jpeg' || $exten == 'png')
                                                <td width="170px"><img
                                                        src="{{ asset('files/user_file/' . $userFile->name) }}"
                                                        alt="" height="100px" width="150px"></td>
                                            @else
                                            ...
                                            <td><input type="text" name="note[]" value="{{ $userFile->note }}"
                                                    class="form-control"></td>
                                            <td style="width: 5px">
                                                <div class="form-button-action">
                                                    <a href="{{ asset('files/user_file/' . $userFile->name) }}"
                                                        class="btn btn-link btn-info" download><i
                                                            class="fas fa-download"></i></a>
                                                    <a href="{{ route('customer.userFileDestroy', $userFile->id) }}"
    ...
    <!-- Modal -->
    <div class="modal fade" id="customer" tabindex="-1" role="dialog" aria-labelledby="customerLabel"
        aria-hidden="true">
                ...
                <form action="{{ route('customer.userFileStore') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td><input type="file" name="name[]" multiple id="medicine_name_1"
                                        class="form-control form-control-sm" style="width:200px" /></td>
                                <td><input type="text" name="note[]" id="qty_1"
                                        class="form-control form-control-sm" placeholder="Note" /></td>
                                <td style="width: 20px"><span class="btn btn-sm btn-success addrow"><i class="fa fa-plus"

        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="{{ route('customer.index')}}">Show Customer</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item active">Edit Business Person/Factory</li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Edit Business Person/Factory</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <select class="form-control" name="role" required>
                                            ...
                                            <option value="3" {{$user->role==3?'selected':''}}>Supplier</option>
                                            <option value="4" {{$user->role==4?'selected':''}}>Factory</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-3">
                                        <label for="tmm_so_id">TMM/SO Id<span class="t_r">*</span></label>

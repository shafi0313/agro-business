        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item active">Add Store</li>
                </ul>
            </div>
                            ...
                            <form action="{{ route('company-store.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        <label for="name">Store Name <span class="t_r">*</span></label>
                                    ...
                                    <div class="form-group col-sm-6">
                                        <label for="tmm_so_id">Store Maneger Id</label>
                                        <input type="text" name="tmm_so_id" class="form-control @error('tmm_so_id') is-invalid @enderror" value="{{old('tmm_so_id')}}" placeholder="Enter Store Id">
                                        @error('tmm_so_id')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>

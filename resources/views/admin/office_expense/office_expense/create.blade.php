...
@section('content')
@php $p = 'account'; $sm='officeExp'; @endphp
        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="{{ route('account-payment.index')}}">Office Expense</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                    <li class="nav-item active">Office Expense To</li>
                </ul>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('office-expense.store')}}" method="post">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-4">
                                        ...
                                        <select name="office_expense_cat_id" id="exp_name" class="form-control" required></select>
                                    </div>
...
<script>
    // Product Price
    $('#exp_type').on('change',function(e) {
            var exp_type = $('#exp_type').val();
            $.ajax({
                url:'{{ route("get.expenseCat") }}',
                type:"get",
                data: {
                    exp_type: exp_type
                    },

        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="{{ route('purchase-bulk.index')}}">Label Purchase</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col text-center">
                                    <p style="font-size: 30px; font-weight: bold;margin-top:-10px">Label Purchase</p>
                                </div>
                                <div class="col-md-3">
                                    <p style="font-size: 18px;font-weight:600;background:green;color:white;margin:0;padding:0px 5px">Bill To</p>
                                    <p style="font-size: 15px">
                                        <span>{{ $supplier->business, }} {{ $supplier->name }}</span><br>
                                        <span>{{ $supplier->address }}</span>
                                    </p>
                                </div>
                            </div>

                        <form action="{{ route('purchase-bulk.store') }}" method="post">
                         @csrf
                            ...
                            <div class="row " >
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="challan_no" class="form-control form-control-sm" value="{{ App\Models\PurchaseLedgerBook::select(['challan_no','type'])->where('type', 7)->count()+1 }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    {{-- <div class="form-group">

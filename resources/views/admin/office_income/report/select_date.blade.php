        ...
        <div class="page-inner">
            <div class="page-header">
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item"><a href="">Office Income Report</a></li>
                    <li class="separator"><i class="flaticon-right-arrow"></i></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body" >
                            <h1 class="text-center mr-5 mb-3">Select the date and show income report</h1>
                            <form action="{{ route('officeIn.report') }}" method="post">
                                @csrf

                                ...
                                <table id="multi-filter-select" class="display table table-striped table-hover" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('empReport.selectDateCredit', $user->id)}}" title="Edit" class="btn btn-link btn-primary">
                                                        Select
                                                    </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    <a href="{{ route('empReport.selectDate', $user->id)}}" title="Edit" class="btn btn-link btn-primary">
                                                        Select
                                                    </a>
                                                </div>
                                            </td>
